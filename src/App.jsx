  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 dark:bg-zinc-950 dark:text-white transition-colors duration-300">
      ...
      <main className="pt-28 px-20 sm:px-40">
        ...
        <p className="px-10 text-lg mb-12">
          Software engineer by trade, design enthusiast by obsession. <br />I
          build{" "}
        ...
        <div className="flex flex-wrap gap-4 px-4 sm:px-10 mb-16">
          ...
          >
           ...
           <a
    href="#projects"
    className="group inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-purple-600 text-white dark:bg-purple-500 font-medium shadow hover:scale-105 transition-transform duration-300"
  >
